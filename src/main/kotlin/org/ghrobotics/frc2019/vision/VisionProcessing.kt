...
object VisionProcessing : FalconSubsystem() {
    ...
    private val frontCameraLED = DigitalOutput(kFrontCameraLEDPort)
    ...
    override fun periodic() {
        ...
        if (!frontCamera.isValid) {
            ...
            val transform = kFrontCameraRelativeToRobot +
        ...
        // LED is low-enabled.
        frontCameraLED.set(!periodicIO.frontCameraLED)
    }

    fun turnOnFrontCameraLED() {
        periodicIO.frontCameraLED = true
    }

    fun turnOffFrontCameraLED() {
        periodicIO.frontCameraLED = false
    }

    private class PeriodicIO {
        var frontCameraLED: Boolean = false
    }
}
